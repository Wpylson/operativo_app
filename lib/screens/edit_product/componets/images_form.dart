...
class ImagesForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FormField<List<dynamic>>(
        initialValue: List.from(product.images),//copia da lista original para receber mudancas sem afectar a lista original
        validator: (images){
          if(images.isEmpty) {
        ...
        builder: (state) {
          //funcao para pegar a imagem selecionada
                        ...
                        Align(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              //Refazer um rebuild depois de remover uma imagem
                              state.didChange(state.value);
                            },
                          ),
                        ),
