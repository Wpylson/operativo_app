...
class CartProduct extends ChangeNotifier {
  ...
  CartProduct.fromDocument(DocumentSnapshot document) {
    ...
    firestore
        .doc('produtos/$productId')
        .get()
        .then(//pegar o produto refente aos dados do cart por id
            (doc) {
  ...
  Map<String, dynamic> toOrderItemMap() {
    return {
      ...
      'fixedPrice': fixedPrice ??
          unitPrice, //se ja tenho um fixed price setado cololo o proprio fixedPrice, caso naao...coloco o unitPrice
    };
  }
